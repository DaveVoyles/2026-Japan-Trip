...
- **What you get:**
  ...
  - **Verdict:** **Highly Recommended.** For a 14-hour flight, the extra legroom and width prevent the "sardine" feeling without the massive price jump of Business.
...
- **What you get:**
  ...
  - **Service:** Lounge access (Polaris Lounge at EWR is excellent), multi-course dining, unlimited drinks, privacy door (on newer planes).
  - **Verdict:** If budget allows, the lie-flat seat guarantees you arrive rested. However, it is often **2-3x the price** of Premium Economy.
...
- **Transport:** Taxi (~8,000 / ) or Monorail/Train (~600 / ).

### Arrival: Tokyo (Narita - NRT)
- **Distance:** 60-90 mins to Ginza/Shimbashi.
- **Transport:** Narita Express (N'EX) or Limousine Bus.
...
- **Transport:** The "Rapi:t" looks like a blue retro-future robot. Very cool.

## Luggage Forwarding (Yamato Transport / "Kuroneko")
- **Don't haul bags on the Bullet Train.**
- Send large suitcases from your Tokyo hotel -> Kyoto hotel.
- Cost: ~/bag. Takes 1 day (overnight).
- Pack a small backpack for the travel day.
