# ✈️ Travel Day Checklists

**Purpose:** Print these or save to phone for each major travel/transition day!
...
- [ ] **Special Meals:** Confirm any dietary requests
- [ ] **Passport Check:** Verify passport is in carry-on (NOT checked bag!)
...
- [ ] **Japanese Language Pack:** Downloaded in Google Translate
- [ ] **Suica Loaded:** ¥5,000 in Apple Wallet
- [ ] **SmartEx App:** Set up with IC card linked
- [ ] **Battery 100%:** Charge phone + portable charger overnight
...
- [ ] **Bring $100-200 USD:** Exchange at airport for initial transportation
...
- [ ] **Comfortable Flight Clothes:** 13+ hours is long!
- [ ] **Light Jacket:** Plane can be cold
- [ ] **Empty Water Bottle:** Fill after security
- [ ] **Snacks:** Plane food isn't always great
- [ ] **Entertainment:** Download movies/shows/books
- [ ] **Headphones:** Essential for long flight
- [ ] **Eye Mask & Earplugs:** Help with sleep
...
- [ ] **Travel Insurance Info:** Card + policy number
- [ ] **Emergency Contacts List:** Printed copy
- [ ] **Credit Cards:** 2+ cards (Visa + Mastercard recommended)
- [ ] **Driver's License:** Secondary ID
...
- [ ] **Check Weather in Tokyo:** Adjust packing if needed
- [ ] **Print Boarding Passes:** If not already done
- [ ] **Currency Exchange:** Or note airport exchange counter location
- [ ] **Pet/Plant Care:** Arranged if applicable
- [ ] **Mail Hold:** USPS hold requested
- [ ] **Home Security:** Lights on timers, notify trusted neighbor
- [ ] **Final Weight Check:** Ensure luggage under 50 lbs (23 kg) airline limit

---

## ✈️ Departure Day from Newark (EWR)
...
- **1.5-2 Hours Before:** Through security
- **1 Hour Before:** At gate
...
- [ ] **Fill Water Bottle:** At water fountain
- [ ] **Bathroom Break:** Before 13-hour flight!
- [ ] **Currency Exchange:** If you want yen before landing (optional)
...
- [ ] **Stretch:** Walk around before long flight
...
- [ ] **Avoid Alcohol:** Dehydrating at altitude
- [ ] **Use Bathroom Before Meal Service:** Lines after meals
...
- [ ] **Pack Up:** Put everything in carry-on, nothing left in seat pocket
- [ ] **Check Under Seat:** Don't leave anything behind!

---

## 🛬 Arrival Day in Tokyo (Day 1)
...
- [ ] **Fingerprints & Photo:** Standard procedure for foreigners
- [ ] **Receive Entry Stamp:** "Temporary Visitor" stamp (needed for tax-free shopping!)
...
- [ ] **Find Currency Exchange:** (If you didn't exchange at Newark)
  ...
  - **Exchange:** ¥20,000-30,000 ($133-200) for first few days
- [ ] **Find ATM:** 7-Eleven ATM or Japan Post Bank (accept foreign cards)
  - **Withdraw:** ¥30,000-50,000 if you prefer cash
- [ ] **Tourist Information:** Pick up free maps, ask questions if needed
- [ ] **Free WiFi:** Connect to airport WiFi to send "landed safely" message
- [ ] **Adjust to Time Zone:** It's probably afternoon/evening in Japan now!

### Getting to Tokyo Hotel:
...
- [ ] **Ticket Counter or Machine:** Buy ticket to Tokyo or Shinjuku
  ...
  - **Shinjuku Station:** ¥3,250 ($22), 90 min
- [ ] **Or Use Suica:** Can tap Suica for regular trains (slower, cheaper)
- [ ] **Platform:** Check monitors for next N'EX departure
- [ ] **Reserved Seat:** Ticket includes reserved seat, find car/seat number
- [ ] **Luggage:** Overhead racks or space near doors
...
- [ ] **Transfer if needed:** From Ueno to final destination
...
- [ ] **Check-in Time:** Usually 3 PM (some hotels flexible)
  - **If Early:** Ask to store luggage: "Nimotsu azukari onegaishimasu"
- [ ] **Provide Passport:** They'll make a copy for registration
- [ ] **Get Room Key:** Usually a physical key + card for power in room
- [ ] **WiFi Info:** Ask for WiFi password if not obvious
...
- [ ] **AC/Heat Control:** Adjust temperature
- [ ] **Locate Emergency Exits:** Note nearest emergency exit
- [ ] **Hotel Business Card:** Take one (for taxis, in case you get lost)
- [ ] **Organize Luggage:** Unpack essentials, hang clothes
...
- [ ] **Early Bed:** Force yourself to sleep by 10-11 PM (jet lag recovery)
- [ ] **Set Alarm:** 6:30 AM for early temple tomorrow!
...
- [ ] **Set Multiple Alarms:** Don't oversleep Day 2!

---

## 🚄 Day 5: Tokyo → Kyoto (Shinkansen Day)
...
- [ ] **Check Closet, Drawers, Bathroom:** Easy to forget things
...
- [ ] **Delivery Time:** Arrives at Kyoto hotel next day (Day 6)
...
- [ ] **Follow Signs:** "Shinkansen" (blue signs with bullet train icon)
  - **Separate from Regular JR:** Shinkansen has its own section of station!
- [ ] **Arrive Early:** Give yourself 30+ minutes to find platform
...
- [ ] **Grab Drinks:** Vending machines or kiosks
- [ ] **Bathroom:** Before boarding (train has bathrooms but often busy)
...
- [ ] **Train Arrives:** Passengers exit first, then board
- [ ] **Doors Open:** Only ~1-2 minutes, board quickly!
...
- [ ] **Tray Table:** Pull down for eating
...
- [ ] **Bathroom if Needed:** Usually between cars
- [ ] **Relax:** You're on the famous Shinkansen!
...
- [ ] **Follow Exit Signs:** To main Kyoto Station area
- [ ] **Orientation:** Kyoto Station is HUGE, take a moment to orient
  - **North Exit:** City center, bus terminal
  - **South Exit:** Shinkansen side
...
## 🚆 Day 8: Kyoto → Osaka (Last City Transfer)
...
## ✈️ Day 9: Departure from Osaka (Going Home)
...
- [ ] **Receive Boarding Pass:** Paper or mobile
...
- [ ] **Random Inspection:** IF asked, show sealed consumables bags
  - **Rare:** 99% of travelers walk right through
...
- [ ] **Shoes On:** (Japan security usually lets you keep shoes on!)
- [ ] **Empty Pockets:** Phone, wallet, keys in bin
...
- [ ] **Charge Devices:** Use outlet at gate area
- [ ] **Bathroom:** Before 13-hour flight!
- [ ] **Grab Snacks/Water:** For flight
- [ ] **Relax:** You made it!

### Before Boarding:

- [ ] **Final Suica Spend:** Use up remaining balance at vending machines
  - **Or keep Suica** as souvenir (can't easily refund digital Suica)
- [ ] **Deactivate eSIM:** Or keep it (might work in future trips)
- [ ] **Send Final Messages:** Let people know you're boarding
- [ ] **Download Entertainment:** Last-minute movies/shows for flight home
...
- [ ] **Stretch:** Walk aisle every few hours

---

## 🏠 Returning Home to Newark
...
- [ ] **Customs:** Usually quick inspection
- [ ] **Welcome Home!** 🇺🇸
...
- [ ] **Back Up Photos:** Copy all photos to computer/cloud storage
- [ ] **Credit Card Statements:** Watch for any fraudulent charges
- [ ] **File Insurance Claims:** If you had any incidents needing reimbursement
- [ ] **Leave Reviews:** Google/TripAdvisor reviews for favorite spots
- [ ] **Share Photos:** With friends and family!

---

## 🎯 Master Packing List (Print This!)
...
- [ ] Medications (full trip supply + extra)
- [ ] Change of clothes (in case checked bag lost)
...
- [ ] Small toiletries (3.4 oz bottles in quart bag)
...
- [ ] Shopping bag (foldable, for purchases)
- [ ] Notebook & pen
- [ ] Book or Kindle
