...
- **Power Banks:** **ChargeSPOT** is a rental service found in almost every Konbini (convenience store).
  You can rent a battery pack in Tokyo and drop it off in Kyoto. Download the app just in case.
  [ChargeSPOT App](https://chargespot.jp/en/)
...
- **Automatic Doors:** The rear left door opens and closes **automatically**. Do NOT touch it. The driver controls it.
- **Payment:** Almost all accept Credit Cards or Suica.
...
- **Rule:** **NO TIPPING.** It is considered rude or confusing.
- **Service:** Excellent service is standard. A simple "Arigato Gozaimasu" is the best reward.

---

## 4. 🗣️ Language & Signs Survival Guide
...
- **Rule:** **Do NOT eat while walking.** It is considered sloppy.
- **Action:** Buy food at a stall/konbini, stand near the shop to eat it, throw trash in their bin, then keep walking.

### Trash

- **Reality:** There are almost **NO public trash cans**.
- **Action:** Carry a small plastic bag (Ziploc) in your backpack. Carry your trash until you find a bin
  (usually at Konbini or Train Stations) or take it back to the hotel.

### Trains

- **Silence:** No phone calls. Set phone to silent mode ("Manner Mode").
- **Backpacks:** Wear them on your **front** or put them on the overhead rack during rush hour.

### Escalators

- **Tokyo:** Stand on the **LEFT**, walk on the Right.
- **Osaka:** Stand on the **RIGHT**, walk on the Left.
- **Kyoto:** Mixed, but usually follows Osaka style. Follow the person in front of you.

### Shoes (Genkan)

- **Rule:** If you see a raised floor or tatami mats, **take off your shoes**.
- **Slippers:**
  - **Guest Slippers:** For walking in the hallway.
  - **Toilet Slippers:** ONLY for inside the toilet. **Do NOT** wear toilet slippers back into the hallway.
...
- **Availability:** Excellent. Train stations, department stores, and Konbini almost always have clean, free toilets.
- **The Buttons:**
  - **Oshiri (Spray):** Rear wash.
  - **Bidet:** Front wash (ladies).
  - **Otohime (Sound Princess):** Plays flushing sound to mask noise.
  - **Flush:** Often a sensor, or a handle labeled "大" (Big flush) or "小" (Small flush).

### Convenience Stores (Konbini)

(7-Eleven, Lawson, FamilyMart)

- **Food:** High quality. Egg salad sandwiches, Onigiri (rice balls), Fried Chicken (Famichiki) are legit meals.
- **Trash:** They have bins for customers.
- **Restrooms:** Usually available (ask staff first).
- **ATMs:** 7-Eleven is best for foreign cards.
...
- [ ] **Google Maps:** Download "Offline Map" for Tokyo/Kyoto/Osaka.
- [ ] **Google Translate:** Download "Japanese" language pack. Use the **Camera** feature to translate menus instantly.
- [ ] **Japan Travel by Navitime:** Best for train platform numbers.
...
- **Airport Timing:** HND is efficient, but security lines can get long. Arrive 2.5 hours early.

## 🔗 Useful Planning Resources

- [Japan Guide May Page](https://www.japan-guide.com/e/e2273.html) - Month-specific travel info.
- [Navitime](https://japantravel.navitime.com/en/area/jp/route/) - Best English train planner.
...
- [Japan National Tourism Org](https://www.japan.travel/en/) - Official event calendar.
