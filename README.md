...
|------|----------|-------------|-------------|
| `data/days.json` | ⚠️ Auto-generated | `visualizations/day-view.html` | Full day-by-day itinerary data |
| `data/day-meta.json` | ✏️ Hand-authored | Build script → `days.json` | Narrative fields (morning/afternoon/night summaries, notes, ops) |
...
> `days.json` is generated by `scripts/build-day-data.js` from `Daily-Briefings/*.md` + `day-meta.json`. To regenerate: `node scripts/build-day-data.js`
